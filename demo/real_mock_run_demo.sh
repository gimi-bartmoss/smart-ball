#!/bin/bash
# demo/real_mock_run_demo.sh
# Automatically launch the real mock esp32 server and visualization program
...
python3 mock_esp32/server.py --mode real --interval 0.5 &
